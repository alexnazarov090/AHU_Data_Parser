...
ahu_sections = [
    ('AHU_NAME',   r'(?:Позиция_*(?:заказчика)?:|(?:Номер|Название|№|Имя)?_?(?:установки|систем[ыа])$)|(?:Position)'),
...
hex_pars_water = [
    ...
    ('MEDIUM_IN_OUTLET_TEMP',   r"""(?:температура_)?(?:теплоносител[ья]|сред[ыа]_)?(?:на_)?входе?_\/_(?:температура_)?
                                        (?:теплоносител[ья]|сред[ыа]_)?(?:на_)?выходе?"""),
    ('MEDIUM_INLET_TEMP',   r'(?:температура_)?(?:теплоносител[ья]|сред[ыа]_)(?:на_)?входе?'),
    ('MEDIUM_OUTLET_TEMP',   r'(?:температура_)?(?:теплоносител[ья]|сред[ыа]_)(?:на_)?выходе?'),
